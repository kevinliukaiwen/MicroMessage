...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body style="background: #e1e9eb;">
		<form action="<c:url value='/ListServlet'/>" id="mainForm" method="post">
			<div class="right">
				<div class="current">当前位置：<a href="javascript:void(0)" style="color:#6E6E6E;">内容管理</a> &gt; 内容列表</div>
				<div class="rightCont">
					<p class="g_title fix">内容列表 <a class="btn03" href="#">新 增</a>&nbsp;&nbsp;&nbsp;&nbsp;<a class="btn03" href="javascript:deleteBatch('<c:url value="/DeleteBatchServlet" />');">删 除</a></p>
					<table class="tab1">
						<tbody>
							<tr>
						...
						<table class="tab2" width="100%">
							<tbody>
								...
								<tr <c:if test="${status.index %2 != 0 }">style='background-color:#ECF6EE;'</c:if>>
									...
									<td>
										<a href="#">修改</a>&nbsp;&nbsp;&nbsp;
										<a href="<c:url value='/DeleteOneServlet?id=${message.id }'/>">删除</a>
									</td>
								</tr>
								</c:forEach>
							</tbody>
